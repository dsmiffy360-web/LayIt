  ...
  return (
    <section style={{ background: COLORS.panel, border: `1px solid ${COLORS.border}`, borderRadius: 10, padding: 18, marginBottom: 18 }}>
      ...
      <div style={{ fontSize: 12, color: COLORS.sub, marginBottom: 12 }}>
        Square cuts only — no angles, except for any piece the room's own angled wall cuts through. Each block is a
        set of parallel strips; most are full length, the rest trimmed to fit the block or the room's edge.
      </div>
