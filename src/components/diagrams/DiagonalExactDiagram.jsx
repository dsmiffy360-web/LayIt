...
export function DiagonalExactDiagram({ result, L, W, unit, pieceLabel = "Plank", sectionLabel = "layout" }) {
  ...
  return (
    <section style={{ background: COLORS.blueprint, borderRadius: 10, padding: "14px 12px 18px", marginBottom: 12 }}>
      <div style={{ fontFamily: "JetBrains Mono", fontSize: 11, color: COLORS.chalk, letterSpacing: "0.06em", marginBottom: 6 }}>
        LAYOUT — {L}{unit} × {W}{unit} · {isPlank ? "diagonal plank" : "diagonal herringbone"} · {result.totalPlanks} {pieceLabel.toLowerCase()}s
      </div>
